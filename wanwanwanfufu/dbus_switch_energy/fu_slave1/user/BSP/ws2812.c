//
// Created by sunmingfeng on 2026/7/20.
//
#include "ws2812.h"
#include <string.h>
...
static WS2812_Strip_t strips[WS2812_STRIP_COUNT] = {
    ...
    {STRIP5_LED_COUNT, STRIP1_LED_COUNT + STRIP2_LED_COUNT + STRIP3_LED_COUNT + STRIP4_LED_COUNT, &htim2, TIM_CHANNEL_3},
    {STRIP6_LED_COUNT, STRIP1_LED_COUNT + STRIP2_LED_COUNT + STRIP3_LED_COUNT + STRIP4_LED_COUNT + STRIP5_LED_COUNT, &htim2, TIM_CHANNEL_4},
};
